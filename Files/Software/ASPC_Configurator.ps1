...
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="27" Width="534" TextWrapping="Wrap" Margin="9,145,0,0" Text="{Binding SPName}" Padding="2,6,0,0" BorderBrush="#4a90e2" Name="ll0yuyrj7giys"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="59" Width="865" TextWrapping="Wrap" Margin="10,200,0,0" Text="{Binding SpNote}" BorderBrush="#4a90e2" Name="ll0yuyrjkxzde"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="27" Width="532" TextWrapping="Wrap" Margin="10,337,0,0" Text="{Binding AlrtDefXMail}" Padding="2,6,0,0" BorderBrush="#4a90e2" Name="ll0yuyrj5uoh9"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="65" Width="866" TextWrapping="Wrap" Margin="10,390,0,0" Text="{Binding AlrtDefXNote}" BorderBrush="#4a90e2" Name="ll0yuyrjk7q16"/>
...
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding Alrt_Def_Output}" Margin="654,72,0,0" Width="227" Height="103" Background="#eeebeb" Name="ll0yuyrk7e2us"/>
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="Output" Margin="608,71,0,0" Width="62" Height="18"/>
...
<Button Content="Clear Fields" HorizontalAlignment="Left" VerticalAlignment="Top" Width="112" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" Margin="247,86,0,0" FontStyle="Italic" Name="ll0yuyrk2pb5e"/>
<Button Content="Save Def" HorizontalAlignment="Left" VerticalAlignment="Top" Width="112" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" Margin="129,86,0,0" FontStyle="Italic" Name="ll0yuyrkuc8yl"/>
<Button Content="Load Alert Def" HorizontalAlignment="Left" VerticalAlignment="Top" Width="112" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" Margin="10,86,0,0" FontStyle="Italic" Name="ll0yuyrkrw8j4"/>
...
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="32" Width="395" TextWrapping="Wrap" Margin="12,280,0,0" Name="ll0yuyrk3ssmh" BorderBrush="#4a90e2" Text="{Binding IntOwnerNote}"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="29" Width="453" TextWrapping="Wrap" Margin="420,281,0,0" Name="ll0yuyrk9dqvh" BorderBrush="#4a90e2" Text="{Binding ExtOwnerNote}"/>
</Grid>
...
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="25" Width="489" TextWrapping="Wrap" Margin="25,114,0,0" Text="{Binding EngConfDefaultEmail}" Padding="2,2,0,0" BorderBrush="#4a90e2" Name="ll0yuyrlmz8qo"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="27" Width="50" TextWrapping="Wrap" Margin="25,302,0,0" Text="{Binding EngConfExpireWithin}" Padding="15,5,0,0" BorderBrush="#4a90e2" Name="ll0yuyrl12ht8"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="32" Width="490" TextWrapping="Wrap" Margin="25,209,0,0" Text="{Binding EngConfReportName}" Padding="2,7,0,0" BorderBrush="#4a90e2" Name="ll0yuyrlquias"/>
...
<CheckBox HorizontalAlignment="Left" VerticalAlignment="Top" Content="Exclude expired (checked = YES / un-checked = NO)" Margin="25.5,398.46875,0,0" IsChecked="{Binding ExcludeExpiredCheckBox}" BorderBrush="#4a90e2" Name="ll0yuyrmwsqhf"/>
...
<Button Content="Test engine" HorizontalAlignment="Left" VerticalAlignment="Top" Width="185" Margin="614,407,0,0" Height="30" Foreground="#4a4a4a" FontSize="016" FontStyle="Italic" FontWeight="ExtraBold" Name="ll0yuyrmkbjwu"/>
...
<TabControl SelectedIndex="{Binding CredsTabIndex}" Name="ll0yuyrnzo02p"><TabItem Header="Instructions"><Grid Background="#ffffff" Margin="0,2,0,-2">
...
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="23" Width="400" TextWrapping="Wrap" Margin="3,154,0,0" BorderBrush="#4a90e2" Text="{Binding SP_AppID}" Name="ll0yuyroru235"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="25" Width="401" TextWrapping="Wrap" Margin="2,219,0,0" BorderBrush="#4a90e2" Text="{Binding SP_TennantID}" Name="ll0yuyroo6m22"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="25" Width="397" TextWrapping="Wrap" Margin="3,282,0,0" BorderBrush="#4a90e2" Text="{Binding Cert_Thumbprint}" Name="ll0yuyro3vxdm"/>
<Button Content="PFX" HorizontalAlignment="Left" VerticalAlignment="Top" Width="75" Margin="477,139,0,0" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" FontStyle="Italic" Name="ll0yuyroiz2v7"/>

<Button Content="SAVE" HorizontalAlignment="Left" VerticalAlignment="Top" Width="75" Margin="442,364,0,0" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" FontStyle="Italic" Name="ll0yuyrp3p9qe"/>
...
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding PFX_Location}" Margin="477,178,0,0" Width="348" Height="58" Background="#e5e4eb" Name="ll0yuyrpnizog"/>
...
<Button Content="Get Pass" HorizontalAlignment="Left" VerticalAlignment="Top" Width="75" Margin="484.5,283.640625,0,0" Name="ll0yuyrpzcxbb"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="57" Width="346" TextWrapping="Wrap" Margin="524.84375,359.578125,0,0" Text="{Binding SP_Page_Output}" Name="ll0yuyrpxwbz1"/>
...
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="20" Width="227" TextWrapping="Wrap" Margin="49,98,0,0" Text="{Binding EmailAddFrom}" Name="ll0yuyrqmxkm6"/>
...
<Button Content="Get Password" HorizontalAlignment="Left" VerticalAlignment="Top" Width="115" Margin="104,170,0,0" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" FontStyle="Italic" Name="ll0yuyrqmx0h3"/>
...
<Button Content="Test Account" HorizontalAlignment="Left" VerticalAlignment="Top" Width="109" Margin="106,278,0,0" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" FontStyle="Italic" Name="ll0yuyrqz4330"/>
<Button Content="Save Account" HorizontalAlignment="Left" VerticalAlignment="Top" Width="114" Margin="103,356,0,0" Height="28" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" FontStyle="Italic" Name="ll0yuyrr3m6zx"/>
...
<ComboBox HorizontalAlignment="Left" VerticalAlignment="Top" Width="120" Margin="56,178,0,0" ItemsSource="{Binding HourComboBox}" SelectedValue="{Binding SelectedHour}" Name="ll0yuyrrxr5qf"/>
<ComboBox HorizontalAlignment="Left" VerticalAlignment="Top" Width="120" Margin="174,178,0,0" SelectedValue="{Binding SelectedTOD}" ItemsSource="{Binding HourAMPM}" Name="ll0yuyrrceekm"/>
...
<ComboBox HorizontalAlignment="Left" VerticalAlignment="Top" Width="120" Margin="292,178,0,0" ItemsSource="{Binding RunDay}" SelectedValue="{Binding SelectedRunDay}" Name="ll0yuyrr3iveq"/>
<Button Content="Create / Update Task" HorizontalAlignment="Left" VerticalAlignment="Top" Width="168" Margin="177,290,0,0" Height="25" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" FontStyle="Italic" Name="ll0yuyrr54aes"/>
...
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding Tasks_Output}" Margin="518.5,94.03125,0,0" Width="363" Height="280" Background="#e5e4eb" Name="ll0yuyrsaxw3d"/>
...
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding AvailWebConfVer}" Margin="247,177,0,0" Width="54" Height="20" Background="#eef3e9" Padding="6,2,0,0" Name="ll0yuyrtb83ni"/>
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding Engine_Ver}" Margin="531,111,0,0" Background="#eef3e9" Width="54" Height="20" Padding="6,2,0,0" Name="ll0yuyrthj8h5"/>
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding AvailWebEngVer}" Margin="533,178,0,0" Width="54" Height="20" Background="#eef3e9" Padding="6,2,0,0" Name="ll0yuyrtghrlk"/>
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding Update_Output}" Margin="81,6,0,0" Width="710" Height="45" Background="{Binding UpdateHeaderColor}" Name="ll0yuyrtfiu7c"/>
...
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding Configurator_Ver}" Margin="171,118,0,0" Background="#edebf3" Width="58" Height="19" Padding="5,0,0,0" Name="ll0yuyru5noyf"/>
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding Engine_Ver}" Margin="141,148,0,0" Width="58" Height="19" Background="#edebf3" Padding="5,0,0,0" Name="ll0yuyruzw8ix"/>
...
$ll0yuyrk2pb5e.Add_Click({alrtDef_Clear_Entries $this $_})
$ll0yuyrkuc8yl.Add_Click({save_alertDef $this $_})
$ll0yuyrkrw8j4.Add_Click({open_alertDef $this $_})
...
$ll0yuyrmwsqhf.Add_Checked({eng_excludeBox_checked $this $_})
$ll0yuyrmwsqhf.Add_Unchecked({eng_excludeBox_unchecked $this $_})
$ll0yuyrmkbjwu.Add_Click({testEngineCreds $this $_})
$ll0yuyroiz2v7.Add_Click({openPFXFile $this $_})
$ll0yuyrp3p9qe.Add_Click({saveSPInformation $this $_})
$ll0yuyrpzcxbb.Add_Click({pfxPasswordSet $this $_})
$ll0yuyrqmx0h3.Add_Click({emailPasswordSet  $this $_})
$ll0yuyrqz4330.Add_Click({testEmailAccount $this $_})
$ll0yuyrr3m6zx.Add_Click({saveEmailAccount $this $_})
$TasksGrid.Add_Loaded({loadTaskPage $this $_})
$ll0yuyrr54aes.Add_Click({saveTask $this $_})
...
Set-Binding -Target $ll0yuyrj7giys -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 10 -Name "SPName"  
Set-Binding -Target $ll0yuyrjkxzde -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 9 -Name "SpNote"  
Set-Binding -Target $ll0yuyrj5uoh9 -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 7 -Name "AlrtDefXMail"  
Set-Binding -Target $ll0yuyrjk7q16 -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 8 -Name "AlrtDefXNote"  
Set-Binding -Target $ll0yuyrk7e2us -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 13 -Name "Alrt_Def_Output"  
Set-Binding -Target $ll0yuyrk3ssmh -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 11 -Name "IntOwnerNote"  
Set-Binding -Target $ll0yuyrk9dqvh -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 12 -Name "ExtOwnerNote"  
Set-Binding -Target $ll0yuyrlmz8qo -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 1 -Name "EngConfDefaultEmail"  
Set-Binding -Target $ll0yuyrl12ht8 -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 4 -Name "EngConfExpireWithin"  
Set-Binding -Target $ll0yuyrlquias -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 5 -Name "EngConfReportName"  
Set-Binding -Target $ll0yuyrmwsqhf -Property $([System.Windows.Controls.CheckBox]::IsCheckedProperty) -Index 3 -Name "ExcludeExpiredCheckBox"  
...
Set-Binding -Target $ll0yuyrnzo02p -Property $([System.Windows.Controls.TabControl]::SelectedIndexProperty) -Index 14 -Name "CredsTabIndex"  
Set-Binding -Target $ll0yuyroru235 -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 19 -Name "SP_AppID"  
Set-Binding -Target $ll0yuyroo6m22 -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 20 -Name "SP_TennantID"  
Set-Binding -Target $ll0yuyro3vxdm -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 21 -Name "Cert_Thumbprint"  
Set-Binding -Target $ll0yuyrpnizog -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 17 -Name "PFX_Location"  
Set-Binding -Target $ll0yuyrpxwbz1 -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 18 -Name "SP_Page_Output"  
Set-Binding -Target $ll0yuyrqmxkm6 -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 23 -Name "EmailAddFrom"  
...
Set-Binding -Target $ll0yuyrrxr5qf -Property $([System.Windows.Controls.ComboBox]::ItemsSourceProperty) -Index 26 -Name "HourComboBox"  
Set-Binding -Target $ll0yuyrrxr5qf -Property $([System.Windows.Controls.ComboBox]::SelectedValueProperty) -Index 28 -Name "SelectedHour"  
Set-Binding -Target $ll0yuyrrceekm -Property $([System.Windows.Controls.ComboBox]::SelectedValueProperty) -Index 29 -Name "SelectedTOD"  
Set-Binding -Target $ll0yuyrrceekm -Property $([System.Windows.Controls.ComboBox]::ItemsSourceProperty) -Index 27 -Name "HourAMPM"  
Set-Binding -Target $ll0yuyrr3iveq -Property $([System.Windows.Controls.ComboBox]::ItemsSourceProperty) -Index 30 -Name "RunDay"  
Set-Binding -Target $ll0yuyrr3iveq -Property $([System.Windows.Controls.ComboBox]::SelectedValueProperty) -Index 31 -Name "SelectedRunDay"  
Set-Binding -Target $ll0yuyrsaxw3d -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 32 -Name "Tasks_Output"  
...
Set-Binding -Target $ll0yuyrtb83ni -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 35 -Name "AvailWebConfVer"  
Set-Binding -Target $ll0yuyrthj8h5 -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 16 -Name "Engine_Ver"  
Set-Binding -Target $ll0yuyrtghrlk -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 34 -Name "AvailWebEngVer"  
Set-Binding -Target $ll0yuyrtfiu7c -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 33 -Name "Update_Output"  
Set-Binding -Target $ll0yuyrtfiu7c -Property $([System.Windows.Controls.TextBlock]::BackgroundProperty) -Index 36 -Name "UpdateHeaderColor"  
Set-Binding -Target $ll0yuyru5noyf -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 15 -Name "Configurator_Ver"  
Set-Binding -Target $ll0yuyruzw8ix -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 16 -Name "Engine_Ver"  
