...
<TabControl Grid.Row="1" Grid.Column="0" Name="ParentTabControl" SelectedIndex="{Binding tabIndex}"><TabItem Header="Home" Visibility="Collapsed"><Grid Background="#ffffff" Name="HomeGrid" Margin="0,2,0,-2">
...
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="27" Width="534" TextWrapping="Wrap" Margin="9,161,0,0" Text="{Binding SPName}" Padding="2,6,0,0" BorderBrush="#4a90e2" Name="lkjzx2w702axn"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="59" Width="865" TextWrapping="Wrap" Margin="9,224,0,0" Text="{Binding SpNote}" BorderBrush="#4a90e2" Name="lkjzx2w7zwmtm"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="27" Width="532" TextWrapping="Wrap" Margin="9,313,0,0" Text="{Binding AlrtDefXMail}" Padding="2,6,0,0" BorderBrush="#4a90e2" Name="lkjzx2w7ctofz"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="65" Width="866" TextWrapping="Wrap" Margin="9,378,0,0" Text="{Binding AlrtDefXNote}" BorderBrush="#4a90e2" Name="lkjzx2w8w9q6k"/>
...
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="External Email Address. Alert external parties. Must be comma seperated addresses." Margin="10,295,0,0" Width="455" Height="21"/>
...
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding Alrt_Def_Output}" Margin="592,109,0,0" Width="227" Height="103" Background="#eeebeb" Name="lkjzx2w8r69mz"/>
...
<Button Content="Clear Fields" HorizontalAlignment="Left" VerticalAlignment="Top" Width="112" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" Margin="247,86,0,0" FontStyle="Italic" Name="lkjzx2w8wfkxp"/>
<Button Content="Save Def" HorizontalAlignment="Left" VerticalAlignment="Top" Width="112" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" Margin="129,86,0,0" FontStyle="Italic" Name="lkjzx2w88fk63"/>
<Button Content="Load Alert Def" HorizontalAlignment="Left" VerticalAlignment="Top" Width="112" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" Margin="10,86,0,0" FontStyle="Italic" Name="lkjzx2w873mp1"/>
</Grid>
...
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="25" Width="489" TextWrapping="Wrap" Margin="25,114,0,0" Text="{Binding EngConfDefaultEmail}" Padding="2,2,0,0" BorderBrush="#4a90e2" Name="lkjzx2w9baa3s"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="27" Width="50" TextWrapping="Wrap" Margin="25,302,0,0" Text="{Binding EngConfExpireWithin}" Padding="15,5,0,0" BorderBrush="#4a90e2" Name="lkjzx2w9fmca9"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="32" Width="490" TextWrapping="Wrap" Margin="25,209,0,0" Text="{Binding EngConfReportName}" Padding="2,7,0,0" BorderBrush="#4a90e2" Name="lkjzx2w9qo4s5"/>
...
<CheckBox HorizontalAlignment="Left" VerticalAlignment="Top" Content="Exclude expired (checked = YES / un-checked = NO)" Margin="25.5,398.46875,0,0" IsChecked="{Binding ExcludeExpiredCheckBox}" BorderBrush="#4a90e2" Name="lkjzx2waer6go"/>
...
<Button Content="Test engine - coming soon" HorizontalAlignment="Left" VerticalAlignment="Top" Width="185" Margin="603.5,338.34375,0,0" Height="30"/>
...
<TabControl SelectedIndex="{Binding CredsTabIndex}" Name="lkjzx2wapyg12"><TabItem Header="Instructions"><Grid Background="#ffffff" Margin="0,2,0,-2">
...
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="23" Width="400" TextWrapping="Wrap" Margin="3,154,0,0" BorderBrush="#4a90e2" Text="{Binding SP_AppID}" Name="lkjzx2wc4gnnj"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="25" Width="401" TextWrapping="Wrap" Margin="2,219,0,0" BorderBrush="#4a90e2" Text="{Binding SP_TennantID}" Name="lkjzx2wcx1dw0"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="25" Width="397" TextWrapping="Wrap" Margin="3,282,0,0" BorderBrush="#4a90e2" Text="{Binding Cert_Thumbprint}" Name="lkjzx2wc1zh0v"/>
<Button Content="PFX" HorizontalAlignment="Left" VerticalAlignment="Top" Width="75" Margin="477,139,0,0" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" FontStyle="Italic" Name="lkjzx2wcmtsgh"/>

<Button Content="SAVE" HorizontalAlignment="Left" VerticalAlignment="Top" Width="75" Margin="442,364,0,0" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" FontStyle="Italic" Name="lkjzx2wc3ubrx"/>
...
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding PFX_Location}" Margin="477,178,0,0" Width="348" Height="58" Background="#e5e4eb" Name="lkjzx2wdi3yez"/>
...
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding SP_Page_Output}" Margin="523.5,357.03125,0,0" Width="333" Height="41" Background="#e5e4eb" Name="lkjzx2wdsqyq5"/>


<Button Content="Button" HorizontalAlignment="Left" VerticalAlignment="Top" Width="75" Margin="484.5,283.640625,0,0" Name="lkjzx2wd06bwp"/>
...
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="20" Width="227" TextWrapping="Wrap" Margin="49,98,0,0" Text="{Binding EmailAddFrom}" Name="lkjzx2wdgoto0"/>
...
<Button Content="Get Password" HorizontalAlignment="Left" VerticalAlignment="Top" Width="115" Margin="104,170,0,0" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" FontStyle="Italic" Name="lkjzx2wd4snqn"/>
...
<Button Content="Test Account" HorizontalAlignment="Left" VerticalAlignment="Top" Width="109" Margin="106,278,0,0" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" FontStyle="Italic" Name="lkjzx2wela4ik"/>
<Button Content="Save Account" HorizontalAlignment="Left" VerticalAlignment="Top" Width="114" Margin="103,356,0,0" Height="28" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" FontStyle="Italic" Name="lkjzx2wedq04f"/>
...
<ComboBox HorizontalAlignment="Left" VerticalAlignment="Top" Width="120" Margin="56,178,0,0" ItemsSource="{Binding HourComboBox}" SelectedValue="{Binding SelectedHour}" Name="lkjzx2wfe1tuo"/>
<ComboBox HorizontalAlignment="Left" VerticalAlignment="Top" Width="120" Margin="174,178,0,0" SelectedValue="{Binding SelectedTOD}" ItemsSource="{Binding HourAMPM}" Name="lkjzx2wf91jy8"/>
...
<ComboBox HorizontalAlignment="Left" VerticalAlignment="Top" Width="120" Margin="292,178,0,0" ItemsSource="{Binding RunDay}" SelectedValue="{Binding SelectedRunDay}" Name="lkjzx2wfy3ioe"/>
<Button Content="Create / Update Task" HorizontalAlignment="Left" VerticalAlignment="Top" Width="168" Margin="177,290,0,0" Height="25" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" FontStyle="Italic" Name="lkjzx2wfwdbcj"/>
...
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding Tasks_Output}" Margin="518.5,94.03125,0,0" Width="363" Height="280" Background="#e5e4eb" Name="lkjzx2wftalmc"/>
...
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding AvailWebConfVer}" Margin="247,177,0,0" Width="54" Height="20" Background="#eef3e9" Padding="6,2,0,0" Name="lkjzx2wgx1b13"/>
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding Engine_Ver}" Margin="531,111,0,0" Background="#eef3e9" Width="54" Height="20" Padding="6,2,0,0" Name="lkjzx2wg9jwwe"/>
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding AvailWebEngVer}" Margin="533,178,0,0" Width="54" Height="20" Background="#eef3e9" Padding="6,2,0,0" Name="lkjzx2wgfa6u6"/>
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding Update_Output}" Margin="81,6,0,0" Width="710" Height="45" Background="{Binding UpdateHeaderColor}" Name="lkjzx2wglhnxf"/>
...
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding Configurator_Ver}" Margin="171,118,0,0" Background="#edebf3" Width="58" Height="19" Padding="5,0,0,0" Name="lkjzx2whg1mas"/>
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding Engine_Ver}" Margin="141,148,0,0" Width="58" Height="19" Background="#edebf3" Padding="5,0,0,0" Name="lkjzx2whopuip"/>
...
function saveSPInformation {
        ...
        $ASPCKeyData = Get-Content "C:\Program Files\Enigma-Tek\ASPC\Configs\Engine\ASPC.key"
        ...
        $ASPCKeyData = Get-Content "C:\Program Files\Enigma-Tek\ASPC\Configs\Engine\ASPC.key"
        $AppID = $State.AppID | ConvertTo-SecureString -AsPlainText -Force
...
function testEmailAccount {
    ...
    $State.EmailAccount_Output += "Test Email looks to have sent. Please check your inbox"
        } 
        Catch {
            
        $State.EmailAccount_Output += "There was an issue sending the Test message. Please check all your settings or the account."
        }
...
function saveTask {
    ...
    if ($SchTime -eq "" -OR $SchDay -eq "" -OR $SchAMPM -eq "") {
        ...
        $action = New-ScheduledTaskAction -Execute 'ASPC_Engine.ps1' -Argument "C:\Program Files\Enigma-Tek\ASPC\Software\"
        $principal = New-ScheduledTaskPrincipal -UserID "LocalService" -RunLevel Highest -LogonType S4U
...
$lkjzx2w8wfkxp.Add_Click({alrtDef_Clear_Entries $this $_})
$lkjzx2w88fk63.Add_Click({save_alertDef $this $_})
$lkjzx2w873mp1.Add_Click({open_alertDef $this $_})
...
$lkjzx2waer6go.Add_Checked({eng_excludeBox_checked $this $_})
$lkjzx2waer6go.Add_Unchecked({eng_excludeBox_unchecked $this $_})
$lkjzx2wcmtsgh.Add_Click({openPFXFile $this $_})
$lkjzx2wc3ubrx.Add_Click({saveSPInformation $this $_})
$lkjzx2wd06bwp.Add_Click({pfxPasswordSet $this $_})
$lkjzx2wd4snqn.Add_Click({emailPasswordSet  $this $_})
$lkjzx2wela4ik.Add_Click({testEmailAccount $this $_})
$lkjzx2wedq04f.Add_Click({saveEmailAccount $this $_})
$TasksGrid.Add_Loaded({loadTaskPage $this $_})
$lkjzx2wfwdbcj.Add_Click({saveTask $this $_})
...
Set-Binding -Target $lkjzx2w702axn -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 10 -Name "SPName"  
Set-Binding -Target $lkjzx2w7zwmtm -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 9 -Name "SpNote"  
Set-Binding -Target $lkjzx2w7ctofz -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 7 -Name "AlrtDefXMail"  
Set-Binding -Target $lkjzx2w8w9q6k -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 8 -Name "AlrtDefXNote"  
Set-Binding -Target $lkjzx2w8r69mz -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 11 -Name "Alrt_Def_Output"  
Set-Binding -Target $lkjzx2w9baa3s -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 1 -Name "EngConfDefaultEmail"  
Set-Binding -Target $lkjzx2w9fmca9 -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 4 -Name "EngConfExpireWithin"  
Set-Binding -Target $lkjzx2w9qo4s5 -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 5 -Name "EngConfReportName"  
Set-Binding -Target $lkjzx2waer6go -Property $([System.Windows.Controls.CheckBox]::IsCheckedProperty) -Index 3 -Name "ExcludeExpiredCheckBox"  
...
Set-Binding -Target $lkjzx2wapyg12 -Property $([System.Windows.Controls.TabControl]::SelectedIndexProperty) -Index 12 -Name "CredsTabIndex"  
Set-Binding -Target $lkjzx2wc4gnnj -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 17 -Name "SP_AppID"  
Set-Binding -Target $lkjzx2wcx1dw0 -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 18 -Name "SP_TennantID"  
Set-Binding -Target $lkjzx2wc1zh0v -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 19 -Name "Cert_Thumbprint"  
Set-Binding -Target $lkjzx2wdi3yez -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 15 -Name "PFX_Location"  
Set-Binding -Target $lkjzx2wdsqyq5 -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 16 -Name "SP_Page_Output"  
Set-Binding -Target $lkjzx2wdgoto0 -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 21 -Name "EmailAddFrom"  
...
Set-Binding -Target $lkjzx2wfe1tuo -Property $([System.Windows.Controls.ComboBox]::ItemsSourceProperty) -Index 24 -Name "HourComboBox"  
Set-Binding -Target $lkjzx2wfe1tuo -Property $([System.Windows.Controls.ComboBox]::SelectedValueProperty) -Index 26 -Name "SelectedHour"  
Set-Binding -Target $lkjzx2wf91jy8 -Property $([System.Windows.Controls.ComboBox]::SelectedValueProperty) -Index 27 -Name "SelectedTOD"  
Set-Binding -Target $lkjzx2wf91jy8 -Property $([System.Windows.Controls.ComboBox]::ItemsSourceProperty) -Index 25 -Name "HourAMPM"  
Set-Binding -Target $lkjzx2wfy3ioe -Property $([System.Windows.Controls.ComboBox]::ItemsSourceProperty) -Index 28 -Name "RunDay"  
Set-Binding -Target $lkjzx2wfy3ioe -Property $([System.Windows.Controls.ComboBox]::SelectedValueProperty) -Index 29 -Name "SelectedRunDay"  
Set-Binding -Target $lkjzx2wftalmc -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 30 -Name "Tasks_Output"  
...
Set-Binding -Target $lkjzx2wgx1b13 -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 33 -Name "AvailWebConfVer"  
Set-Binding -Target $lkjzx2wg9jwwe -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 14 -Name "Engine_Ver"  
Set-Binding -Target $lkjzx2wgfa6u6 -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 32 -Name "AvailWebEngVer"  
Set-Binding -Target $lkjzx2wglhnxf -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 31 -Name "Update_Output"  
Set-Binding -Target $lkjzx2wglhnxf -Property $([System.Windows.Controls.TextBlock]::BackgroundProperty) -Index 34 -Name "UpdateHeaderColor"  
Set-Binding -Target $lkjzx2whg1mas -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 13 -Name "Configurator_Ver"  
Set-Binding -Target $lkjzx2whopuip -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 14 -Name "Engine_Ver"  
