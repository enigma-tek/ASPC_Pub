...
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="27" Width="534" TextWrapping="Wrap" Margin="9,161,0,0" Text="{Binding SPName}" Padding="2,6,0,0" BorderBrush="#4a90e2" Name="lkufkje123np9"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="59" Width="865" TextWrapping="Wrap" Margin="9,224,0,0" Text="{Binding SpNote}" BorderBrush="#4a90e2" Name="lkufkje132bxn"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="27" Width="532" TextWrapping="Wrap" Margin="9,313,0,0" Text="{Binding AlrtDefXMail}" Padding="2,6,0,0" BorderBrush="#4a90e2" Name="lkufkje1kuahf"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="65" Width="866" TextWrapping="Wrap" Margin="9,378,0,0" Text="{Binding AlrtDefXNote}" BorderBrush="#4a90e2" Name="lkufkje1zz4rf"/>
...
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding Alrt_Def_Output}" Margin="592,109,0,0" Width="227" Height="103" Background="#eeebeb" Name="lkufkje2c1ka7"/>
...
<Button Content="Clear Fields" HorizontalAlignment="Left" VerticalAlignment="Top" Width="112" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" Margin="247,86,0,0" FontStyle="Italic" Name="lkufkje25has8"/>
<Button Content="Save Def" HorizontalAlignment="Left" VerticalAlignment="Top" Width="112" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" Margin="129,86,0,0" FontStyle="Italic" Name="lkufkje292x4p"/>
<Button Content="Load Alert Def" HorizontalAlignment="Left" VerticalAlignment="Top" Width="112" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" Margin="10,86,0,0" FontStyle="Italic" Name="lkufkje2168dm"/>
</Grid>
...
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="25" Width="489" TextWrapping="Wrap" Margin="25,114,0,0" Text="{Binding EngConfDefaultEmail}" Padding="2,2,0,0" BorderBrush="#4a90e2" Name="lkufkje3fxm68"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="27" Width="50" TextWrapping="Wrap" Margin="25,302,0,0" Text="{Binding EngConfExpireWithin}" Padding="15,5,0,0" BorderBrush="#4a90e2" Name="lkufkje3u8jj9"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="32" Width="490" TextWrapping="Wrap" Margin="25,209,0,0" Text="{Binding EngConfReportName}" Padding="2,7,0,0" BorderBrush="#4a90e2" Name="lkufkje3m08pa"/>
...
<CheckBox HorizontalAlignment="Left" VerticalAlignment="Top" Content="Exclude expired (checked = YES / un-checked = NO)" Margin="25.5,398.46875,0,0" IsChecked="{Binding ExcludeExpiredCheckBox}" BorderBrush="#4a90e2" Name="lkufkje5iznso"/>
...
<Button Content="Test engine" HorizontalAlignment="Left" VerticalAlignment="Top" Width="185" Margin="614,407,0,0" Height="30" Foreground="#4a4a4a" FontSize="016" FontStyle="Italic" FontWeight="ExtraBold" Name="lkufkje56szha"/>
...
<TabControl SelectedIndex="{Binding CredsTabIndex}" Name="lkufkje57pnbm"><TabItem Header="Instructions"><Grid Background="#ffffff" Margin="0,2,0,-2">
...
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="23" Width="400" TextWrapping="Wrap" Margin="3,154,0,0" BorderBrush="#4a90e2" Text="{Binding SP_AppID}" Name="lkufkje6n8geu"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="25" Width="401" TextWrapping="Wrap" Margin="2,219,0,0" BorderBrush="#4a90e2" Text="{Binding SP_TennantID}" Name="lkufkje6vdark"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="25" Width="397" TextWrapping="Wrap" Margin="3,282,0,0" BorderBrush="#4a90e2" Text="{Binding Cert_Thumbprint}" Name="lkufkje60l1pn"/>
<Button Content="PFX" HorizontalAlignment="Left" VerticalAlignment="Top" Width="75" Margin="477,139,0,0" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" FontStyle="Italic" Name="lkufkje7q802c"/>

<Button Content="SAVE" HorizontalAlignment="Left" VerticalAlignment="Top" Width="75" Margin="442,364,0,0" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" FontStyle="Italic" Name="lkufkje7sihbx"/>
...
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding PFX_Location}" Margin="477,178,0,0" Width="348" Height="58" Background="#e5e4eb" Name="lkufkje7br6qf"/>
...
<Button Content="Get Pass" HorizontalAlignment="Left" VerticalAlignment="Top" Width="75" Margin="484.5,283.640625,0,0" Name="lkufkje8clvkv"/>
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="57" Width="346" TextWrapping="Wrap" Margin="524.84375,359.578125,0,0" Text="{Binding SP_Page_Output}" Name="lkufkje8ei44j"/>
...
<TextBox HorizontalAlignment="Left" VerticalAlignment="Top" Height="20" Width="227" TextWrapping="Wrap" Margin="49,98,0,0" Text="{Binding EmailAddFrom}" Name="lkufkje8ohlx4"/>
...
<Button Content="Get Password" HorizontalAlignment="Left" VerticalAlignment="Top" Width="115" Margin="104,170,0,0" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" FontStyle="Italic" Name="lkufkje8txqed"/>
...
<Button Content="Test Account" HorizontalAlignment="Left" VerticalAlignment="Top" Width="109" Margin="106,278,0,0" Height="30" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" FontStyle="Italic" Name="lkufkje9c3vmq"/>
<Button Content="Save Account" HorizontalAlignment="Left" VerticalAlignment="Top" Width="114" Margin="103,356,0,0" Height="28" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" FontStyle="Italic" Name="lkufkje9pu8yy"/>
...
<ComboBox HorizontalAlignment="Left" VerticalAlignment="Top" Width="120" Margin="56,178,0,0" ItemsSource="{Binding HourComboBox}" SelectedValue="{Binding SelectedHour}" Name="lkufkjeaw7jr9"/>
<ComboBox HorizontalAlignment="Left" VerticalAlignment="Top" Width="120" Margin="174,178,0,0" SelectedValue="{Binding SelectedTOD}" ItemsSource="{Binding HourAMPM}" Name="lkufkjeaxlwph"/>
...
<ComboBox HorizontalAlignment="Left" VerticalAlignment="Top" Width="120" Margin="292,178,0,0" ItemsSource="{Binding RunDay}" SelectedValue="{Binding SelectedRunDay}" Name="lkufkjeboagb1"/>
<Button Content="Create / Update Task" HorizontalAlignment="Left" VerticalAlignment="Top" Width="168" Margin="177,290,0,0" Height="25" Foreground="#194d4a" BorderBrush="#194d4a" FontSize="15" FontWeight="Bold" Background="#ffffff" FontStyle="Italic" Name="lkufkjeb73wht"/>
...
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding Tasks_Output}" Margin="518.5,94.03125,0,0" Width="363" Height="280" Background="#e5e4eb" Name="lkufkjecnj3az"/>
...
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding AvailWebConfVer}" Margin="247,177,0,0" Width="54" Height="20" Background="#eef3e9" Padding="6,2,0,0" Name="lkufkjecracr7"/>
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding Engine_Ver}" Margin="531,111,0,0" Background="#eef3e9" Width="54" Height="20" Padding="6,2,0,0" Name="lkufkjecrx0la"/>
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding AvailWebEngVer}" Margin="533,178,0,0" Width="54" Height="20" Background="#eef3e9" Padding="6,2,0,0" Name="lkufkjecq9y1v"/>
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding Update_Output}" Margin="81,6,0,0" Width="710" Height="45" Background="{Binding UpdateHeaderColor}" Name="lkufkjec4fy7h"/>
...
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding Configurator_Ver}" Margin="171,118,0,0" Background="#edebf3" Width="58" Height="19" Padding="5,0,0,0" Name="lkufkjeduiipl"/>
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="{Binding Engine_Ver}" Margin="141,148,0,0" Width="58" Height="19" Background="#edebf3" Padding="5,0,0,0" Name="lkufkjeey8ev9"/>
...
$lkufkje25has8.Add_Click({alrtDef_Clear_Entries $this $_})
$lkufkje292x4p.Add_Click({save_alertDef $this $_})
$lkufkje2168dm.Add_Click({open_alertDef $this $_})
...
$lkufkje5iznso.Add_Checked({eng_excludeBox_checked $this $_})
$lkufkje5iznso.Add_Unchecked({eng_excludeBox_unchecked $this $_})
$lkufkje56szha.Add_Click({testEngineCreds $this $_})
$lkufkje7q802c.Add_Click({openPFXFile $this $_})
$lkufkje7sihbx.Add_Click({saveSPInformation $this $_})
$lkufkje8clvkv.Add_Click({pfxPasswordSet $this $_})
$lkufkje8txqed.Add_Click({emailPasswordSet  $this $_})
$lkufkje9c3vmq.Add_Click({testEmailAccount $this $_})
$lkufkje9pu8yy.Add_Click({saveEmailAccount $this $_})
$TasksGrid.Add_Loaded({loadTaskPage $this $_})
$lkufkjeb73wht.Add_Click({saveTask $this $_})
...
Set-Binding -Target $lkufkje123np9 -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 10 -Name "SPName"  
Set-Binding -Target $lkufkje132bxn -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 9 -Name "SpNote"  
Set-Binding -Target $lkufkje1kuahf -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 7 -Name "AlrtDefXMail"  
Set-Binding -Target $lkufkje1zz4rf -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 8 -Name "AlrtDefXNote"  
Set-Binding -Target $lkufkje2c1ka7 -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 11 -Name "Alrt_Def_Output"  
Set-Binding -Target $lkufkje3fxm68 -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 1 -Name "EngConfDefaultEmail"  
Set-Binding -Target $lkufkje3u8jj9 -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 4 -Name "EngConfExpireWithin"  
Set-Binding -Target $lkufkje3m08pa -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 5 -Name "EngConfReportName"  
Set-Binding -Target $lkufkje5iznso -Property $([System.Windows.Controls.CheckBox]::IsCheckedProperty) -Index 3 -Name "ExcludeExpiredCheckBox"  
...
Set-Binding -Target $lkufkje57pnbm -Property $([System.Windows.Controls.TabControl]::SelectedIndexProperty) -Index 12 -Name "CredsTabIndex"  
Set-Binding -Target $lkufkje6n8geu -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 17 -Name "SP_AppID"  
Set-Binding -Target $lkufkje6vdark -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 18 -Name "SP_TennantID"  
Set-Binding -Target $lkufkje60l1pn -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 19 -Name "Cert_Thumbprint"  
Set-Binding -Target $lkufkje7br6qf -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 15 -Name "PFX_Location"  
Set-Binding -Target $lkufkje8ei44j -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 16 -Name "SP_Page_Output"  
Set-Binding -Target $lkufkje8ohlx4 -Property $([System.Windows.Controls.TextBox]::TextProperty) -Index 21 -Name "EmailAddFrom"  
...
Set-Binding -Target $lkufkjeaw7jr9 -Property $([System.Windows.Controls.ComboBox]::ItemsSourceProperty) -Index 24 -Name "HourComboBox"  
Set-Binding -Target $lkufkjeaw7jr9 -Property $([System.Windows.Controls.ComboBox]::SelectedValueProperty) -Index 26 -Name "SelectedHour"  
Set-Binding -Target $lkufkjeaxlwph -Property $([System.Windows.Controls.ComboBox]::SelectedValueProperty) -Index 27 -Name "SelectedTOD"  
Set-Binding -Target $lkufkjeaxlwph -Property $([System.Windows.Controls.ComboBox]::ItemsSourceProperty) -Index 25 -Name "HourAMPM"  
Set-Binding -Target $lkufkjeboagb1 -Property $([System.Windows.Controls.ComboBox]::ItemsSourceProperty) -Index 28 -Name "RunDay"  
Set-Binding -Target $lkufkjeboagb1 -Property $([System.Windows.Controls.ComboBox]::SelectedValueProperty) -Index 29 -Name "SelectedRunDay"  
Set-Binding -Target $lkufkjecnj3az -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 30 -Name "Tasks_Output"  
...
Set-Binding -Target $lkufkjecracr7 -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 33 -Name "AvailWebConfVer"  
Set-Binding -Target $lkufkjecrx0la -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 14 -Name "Engine_Ver"  
Set-Binding -Target $lkufkjecq9y1v -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 32 -Name "AvailWebEngVer"  
Set-Binding -Target $lkufkjec4fy7h -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 31 -Name "Update_Output"  
Set-Binding -Target $lkufkjec4fy7h -Property $([System.Windows.Controls.TextBlock]::BackgroundProperty) -Index 34 -Name "UpdateHeaderColor"  
Set-Binding -Target $lkufkjeduiipl -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 13 -Name "Configurator_Ver"  
Set-Binding -Target $lkufkjeey8ev9 -Property $([System.Windows.Controls.TextBlock]::TextProperty) -Index 14 -Name "Engine_Ver"  
